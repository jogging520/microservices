package com.northbrain.common.callgraph;
...
{
    private static Logger logger = Logger.getLogger(CallGraphApplication.class);
        ...
        try
        {
            if(LauncherUitl.parseCommandLine(arguments))
            {
                ...
                LauncherUitl.appendParameter(Constants.STORAGE_ZOOKEEPER_BUSINESS_NAMESPACE,
                        ...
                        Constants.BUSINESS_COMMON_CALL_GRAPH_ATOM_MICROSERVICE);
                //设置日志级别
                LauncherUitl.setLog();
                ...
                SpringApplication springApplication = new SpringApplication(CallGraphApplication.class);
