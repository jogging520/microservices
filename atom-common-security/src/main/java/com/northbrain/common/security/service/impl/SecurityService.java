...
public class SecurityService implements ISecurityService
{
     ...
     */
    @Override
    public ServiceVO readAccessControlsByRole(Integer roleId, String domain, int privilegeId)
    {
        ServiceVO serviceVO = new ServiceVO();
        ...
        try
        {
            ...
            accessControlVOS = securityDomain.readAccessControlsByRole(roleId, domain, privilegeId);
