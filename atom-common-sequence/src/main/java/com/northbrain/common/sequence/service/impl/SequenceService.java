...
public class SequenceService implements ISequenceService
{
     ...
     */
    @Override
    public ServiceVO readOperationRecordId()
    {
        ...
        try
        {
            ...
            nextValue = sequenceDomain.readOperationRecordId();
     ...
     */
    @Override
    public ServiceVO readRegistryId()
    {
        ServiceVO serviceVO = new ServiceVO();
        int nextValue;
        ...
        try
        {
            ...
            nextValue = sequenceDomain.readRegistryId();
            serviceVO.setResponse(nextValue);
            serviceVO.setResponseCodeAndDesc(Errors.SUCCESS_EXECUTE);
        }
        catch (NumberFormatException numberFormatException)
    ...
    public ServiceVO readLoginId()
    {
        ...
        try
        {
            ...
            nextValue = sequenceDomain.readLoginId();
            serviceVO.setResponse(nextValue);
            serviceVO.setResponseCodeAndDesc(Errors.SUCCESS_EXECUTE);
        }
        catch (NumberFormatException numberFormatException)
    ...
    public ServiceVO readPartyId()
    {
        ...
        try
        {
            ...
            nextValue = sequenceDomain.readPartyId();
            serviceVO.setResponse(nextValue);
            serviceVO.setResponseCodeAndDesc(Errors.SUCCESS_EXECUTE);
        }
        catch (NumberFormatException numberFormatException)
