package com.northbrain.common.strategy;
...
{
    private static Logger logger = Logger.getLogger(StrategyApplication.class);
    ...
    public static void main(String[] arguments) {
        try {
            if (LauncherUitl.parseCommandLine(arguments)) {
                ...
                SpringApplication springApplication = new SpringApplication(StrategyApplication.class);
