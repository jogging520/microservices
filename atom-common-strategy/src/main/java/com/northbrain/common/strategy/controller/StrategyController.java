...
public class StrategyController
{
    ...
    {
        logger.debug(Hints.HINT_SYSTEM_PROCESS_CALL_CONTROLLER + "readStrategiesByName");
        ...
        try
        {
            ...
            return JSON.toJSONString(strategyService.readStrategiesByName(orchStrategyVO));
        }
