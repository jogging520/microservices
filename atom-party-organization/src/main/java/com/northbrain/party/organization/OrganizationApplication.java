package com.northbrain.party.organization;
...
{
    private static Logger logger = Logger.getLogger(OrganizationApplication.class);
        ...
        try {
            if (LauncherUitl.parseCommandLine(arguments)) {
                ...
                LauncherUitl.appendParameter(Constants.STORAGE_ZOOKEEPER_BUSINESS_NAMESPACE,
                        ...
                        Constants.BUSINESS_PARTY_ORGANIZATION_ATOM_MICROSERVICE);
                //设置日志级别
                LauncherUitl.setLog();
                ...
                SpringApplication springApplication = new SpringApplication(OrganizationApplication.class);
