package com.northbrain.party.role;
...
{
    private static Logger logger = Logger.getLogger(RoleApplication.class);
        ...
        try
        {
            if(LauncherUitl.parseCommandLine(arguments))
            {
                ...
                LauncherUitl.appendParameter(Constants.STORAGE_ZOOKEEPER_BUSINESS_NAMESPACE,
                        ...
                        Constants.BUSINESS_PARTY_ROLE_ATOM_MICROSERVICE);
                //设置日志级别
                LauncherUitl.setLog();
                ...
                SpringApplication springApplication = new SpringApplication(RoleApplication.class);
