package com.northbrain.product.operation.service.impl;
...
public class OperationRecordService implements IOperationRecordService
{
    ...
    public ServiceVO createOperationRecord(OperationRecordVO operationRecordVO)
    {
        ...
        try
        {
            ...
            isCreated = operationRecordDomain.createOperationRecord(operationRecordVO);
            serviceVO.setResponse(isCreated);
        }
