package com.northbrain.resource.basic;
...
{
    private static Logger logger = Logger.getLogger(ResourceApplication.class);
    ...
    public static void main(String[] arguments) {
        try {
            if (LauncherUitl.parseCommandLine(arguments)) {
                ...
                SpringApplication springApplication = new SpringApplication(ResourceApplication.class);
