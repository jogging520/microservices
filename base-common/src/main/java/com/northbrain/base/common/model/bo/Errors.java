...
public enum Errors
{
    ...
    ERROR_BUSINESS_PARTY_ROLE_EXCEPTION                             ("3131", "操作角色及参与者时候发生异常。"),
    ERROR_BUSINESS_PARTY_ROLE_INSERT                                ("3132", "插入角色及参与者时候发生异常。"),
    ERROR_BUSINESS_PARTY_ROLE_UPDATE                                ("3133", "更新角色及参与者时候发生异常。"),
    ERROR_BUSINESS_PARTY_ROLE_DELETE                                ("3134", "删除角色及参与者时候发生异常。"),
