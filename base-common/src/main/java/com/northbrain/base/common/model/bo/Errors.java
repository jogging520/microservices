...
public enum Errors
{
    ...
    ERROR_BUSINESS_COMMON_SECURITY_ACCESS_CONTROL_EXCEPTION         ("3013", "操作访问控制信息时候发生异常。"),
    ...
    ERROR_BUSINESS_COMMON_VALUE_OBJECT_PROPERTY_CATEGORY_ENUM       ("3023", "值对象的类别属性category取值不在枚举范围内。"),
    ERROR_BUSINESS_COMMON_VALUE_OBJECT_PROPERTY_TYPE_ENUM           ("3024", "值对象的类型属性type取值不在枚举范围内。"),
    ...
    ERROR_BUSINESS_PRODUCT_BASIC_EXCEPTION                          ("3171", "操作产品时候发生异常。"),
    ERROR_BUSINESS_PRODUCT_BASIC_INSERT                             ("3172", "插入产品时候发生异常。"),
    ERROR_BUSINESS_PRODUCT_BASIC_UPDATE                             ("3173", "更新产品时候发生异常。"),
    ERROR_BUSINESS_PRODUCT_BASIC_DELETE                             ("3174", "删除产品时候发生异常。"),
